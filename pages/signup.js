                ...
                <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-md w-full space-y-8">
                        <div>
                            ...
                            <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Signup for your new account</h2>
                            <p className="mt-2 text-center text-sm text-gray-600">
                                Or
                                <Link href={"/login"}><a href="#" class="font-medium text-pink-600 hover:text-pink-500">Signin</a></Link>
                        ...
                        <form onSubmit={handleSubmit} className="mt-8 space-y-6" method="POST">
                            ...
                            <div className="rounded-md shadow-sm -space-y-px">
                                <div className="my-2">
                                    ...
                                    <input onChange={handleInput} value={username} id="name" name="name" type="text" required className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-pink-500 focus:border-pink-500 focus:z-10 sm:text-sm" placeholder="Your Name" />
                                </div>
                                <div className="my-2">
